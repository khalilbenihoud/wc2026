...
async function main() {
  ...
  const body =
    ...
    `// Country outlines from mapsicon (public domain); Morocco from simplemaps.com\n` +
    `// (dissolved to one outline by scripts/dissolve-morocco.py). viewBox is 0 0 1024 1024.\n\n` +
